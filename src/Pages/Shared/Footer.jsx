            ...
            <div className="mx-auto mt-8 max-w-md sm:ml-0">
              ...
              <form className="mt-4">
                <div className="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                  ...
                  <input
                    className="w-full rounded-full focus:outline-none border-gray-200  px-6 py-3 shadow-sm focus:shadow-lg"
                    type="email"
                    placeholder="Enter your email"
                  />

                  <button
                    className="block rounded-full bg-red-500 px-5 py-2 font-medium text-white transition hover:bg-red-600"
                    type="submit"
                  >
                    Subscribe
                  </button>
