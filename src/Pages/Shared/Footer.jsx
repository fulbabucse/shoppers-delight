  ...
  return (
    <footer aria-label="Site Footer" class="bg-white">
      <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8">
        <div class="mt-16 grid grid-cols-1 gap-8 border-t border-gray-100 pt-16 md:grid-cols-4 lg:grid-cols-6">
            ...
            <div class="mx-auto mt-8 max-w-md sm:ml-0">
              ...
              <form class="mt-4">
                <div class="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                  ...
                  <input
                    class="w-full rounded-full focus:outline-none border-gray-200  px-6 py-3 shadow-sm focus:shadow-lg"
                    type="email"
                    placeholder="Enter your email"
                  />

                  <button
                    class="block rounded-full bg-red-500 px-8 py-3 font-medium text-white transition hover:bg-red-600"
                    type="submit"
                  >
                    Subscribe
                  </button>
